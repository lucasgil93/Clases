...
//7. Creamos algunos objetos para ver como funciona el programa

let movil1 = new Movil (1, "IPhone", 1000, "15 Pro Max", false);

let movil2 = new Movil (2, "Samsung", 1000, "S23", true);

let carcasa1 = new Carcasa(3, "Carcasa IPhone Madera", 25, "Madera");
let carcasa2 = new Carcasa(4, "Carcasa Samsung Plastico", 10, "Plástico");

almacen.altaProducto(movil1);
almacen.altaProducto(movil2);
almacen.altaProducto(carcasa1);
almacen.altaProducto(carcasa2);
